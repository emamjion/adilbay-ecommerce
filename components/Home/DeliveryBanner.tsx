...
export default function DeliveryBanner() {
  return (
    <section className="w-full py-10 overflow-x-hidden">
      <div className="max-w-7xl mx-auto bg-linear-to-r from-[#0f766e] to-[#115e59] rounded-3xl px-4 sm:px-6 md:px-10 py-10 flex flex-col lg:flex-row items-center justify-between gap-8 overflow-hidden">
        {/* LEFT IMAGE */}
        <motion.div
